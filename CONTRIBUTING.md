...
* [Submit a post for your issue](https://github.com/akaneda/akaneda/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/akaneda/akaneda/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/akaneda.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/akaneda/akaneda/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/akaneda/akaneda/compare/).
...
* Engage in discussion on [your issue](https://github.com/akaneda/akaneda/issues/).
