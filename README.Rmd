...
You can download the compendium as a zip from from this URL: <https://github.com/akaneda/akaneda/archive/master.zip>

Or you can install this compendium as an R package, akaneda, from GitHub with:
